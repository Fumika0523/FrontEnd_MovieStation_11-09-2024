    ...
    <Grid lg={4} md={6} sm={6} xs={12} xl={3} item marginBottom={2}>
      ...
      >
        <CardHeader
          ...
          action={
            ...
            >
              ...
              {/* Edit & Delete - only if logged in and owner */}
              {token && isMovieOwner && (
                <>
                  <Tooltip title="Edit">
                    <ModeIcon
        ...
        <CardMedia
          ...
          width="100%"
          image={movieposter}
          style={{ objectFit: "cover", display: "block", height: "210px" }}
          alt="movieposter"
        />

        {/* PRICE */}
        <div style={{ right: "40px", top: '63px', position: "absolute" }}>
          ${amount}
        </div>

        {/* CART ICON */}
        <div style={{ right: "5px", top: '63px', position: "absolute" }}>
          {reduxAddcartBtn}
        </div>
