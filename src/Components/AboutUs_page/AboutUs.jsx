...
//   <div className=" border row align-items-center p-5">
//     <h1 className="text-center border  pb-4"> What we do</h1>
//     {/* 1st section */}
